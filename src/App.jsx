...
export default function DynamaxProductionScenarioTool() {
  ...
  const [bestYoYLF, setBestYoYLF] = useState(1594213);
  ...
  const results = useMemo(() => {
    ...
    return {
      ...
      selectedScenario,
      currentScenario,
      gainVsCurrentPerDay: selectedScenario.adjustedLfPerDay - currentScenario.adjustedLfPerDay,
      gainVsCurrentPerYear: selectedScenario.adjustedAnnualLF - currentScenario.adjustedAnnualLF,
      ...
      gapToBestYoY: selectedScenario.adjustedAnnualLF - bestYoYLF,
    };
  }, [
    selectedPreset,
    currentPreset,
        ...
        <div className="rounded-3xl border border-sky-200 bg-white/95 p-6 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              <img src={LOGO} alt="WAVE logo" className="h-16 w-auto rounded-xl bg-white p-1" />
              <div>
        ...
        <div className="grid gap-6 xl:grid-cols-[390px,1fr]">
          ...
          <div className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <MetricCard title="Gain vs Current / Year" value={fmt0.format(results.gainVsCurrentPerYear)} subtitle="Selected mode vs current mode under same scenario inputs" />
            </div>
            ...
            <Card title="Executive Summary" blue={true}>
              <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
                ...
                <DetailBox label="Gap to Annual Goal" value={fmt0.format(results.gapToAnnualGoal)} helper={`${results.gapToAnnualGoal >= 0 ? "Above" : "Below"} ${fmt0.format(annualGoalLF)}`} />
                <DetailBox label="Gap to Best YoY" value={fmt0.format(results.gapToBestYoY)} helper={`${results.gapToBestYoY >= 0 ? "Above" : "Below"} ${fmt0.format(bestYoYLF)}`} />
                ...
                <table className="min-w-full text-left text-sm">
                  ...
                  <tbody className="text-slate-800">
                    <tr className="border-b border-slate-100">
                      ...
                      <td className={`py-3 ${comparisonTone(selectedPreset.lfPerHour - currentPreset.lfPerHour)}`}>{fmt0.format(selectedPreset.lfPerHour - currentPreset.lfPerHour)}</td>
                    </tr>
                    <tr className="border-b border-slate-100">
                      ...
                      <td className={`py-3 ${comparisonTone(selectedPreset.lfPerDay - currentPreset.lfPerDay)}`}>{fmt0.format(selectedPreset.lfPerDay - currentPreset.lfPerDay)}</td>
                    </tr>
                    <tr className="border-b border-slate-100">
                      ...
                      <td className={`py-3 ${comparisonTone(results.gainVsCurrentPerDay)}`}>{fmt0.format(results.gainVsCurrentPerDay)}</td>
                    </tr>
                    <tr>
                      ...
                      <td className={`py-3 ${comparisonTone(results.gainVsCurrentPerYear)}`}>{fmt0.format(results.gainVsCurrentPerYear)}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <Card title="Leadership Notes">
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <DetailBox label="Best Use" value="Decision Support" helper="Ideal for showing mode changes, gap to target, and upside vs current state." />
              </div>
            </Card>
          </div>
        </div>
